...
export default function ConfigContainer() {
  return (
    <Card elevation={Elevation.TWO}>
      ...
      <strong>
        A companion website is required in order for you to be able to use the Speech To Text Closed
        Captioning.
      </strong>
      ...
      <ol className="bp3-list">
        ...
        <li>
          Login with your Twitch Account. <em>This is needed so Speech to Text works</em>.
        </li>
        <li>
          Visit the <em>Dashboard</em>
        </li>
        <li>
          To start <em>Closed Captioning</em> for your stream, toggle "Closed Captioning"{' '}
          <strong>On</strong>.
        </li>
        <li>
